...
/* harmony import */ var _emp_details_emp_details_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./emp-details/emp-details.component */ "./src/app/emp-details/emp-details.component.ts");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _emp_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./emp.service */ "./src/app/emp.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _emp_details_emp_details_component__WEBPACK_IMPORTED_MODULE_3__["EmpDetailsComponent"]
            ],
            imports: [
                _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
                _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"]
            ],
            providers: [_emp_service__WEBPACK_IMPORTED_MODULE_5__["EmpService"]],
...
var EmpDetailsComponent = /** @class */ (function () {
    function EmpDetailsComponent(_emp) {
        this._emp = _emp;
        this.employees = [];
        this.errormsg = "";
    }
    EmpDetailsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this._emp.getEmployees().subscribe(function (data) { return _this.employees = data; }, function (error) { return _this.errormsg = error; });
    };
    EmpDetailsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_emp_service__WEBPACK_IMPORTED_MODULE_1__["EmpService"]])
    ], EmpDetailsComponent);
...
var EmpService = /** @class */ (function () {
    function EmpService(http) {
        this.http = http;
        this.url = "http://localhost:4444/something";
    }
    EmpService.prototype.getEmployees = function () {
        return this.http.get(this.url);
    };
    EmpService.prototype.errorHandler = function (error) {
        rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"].throw(error.message || "server error");
    };
...
module.exports = __webpack_require__(/*! /Users/vijaygarg/Desktop/webdevelopment/practise/bootcamp/Angular/Practise/httpservicepractise/httpser/src/main.ts */"./src/main.ts");
